...
export function SiteHeader() {
  ...
  return (
    ...
    >
      <div
        className="screen-line-before screen-line-after mx-auto flex h-12 items-center justify-between gap-2 border- border- px-2 after:z-1 after:transition-[background-color] sm:gap-4 md:max-w-4xl"
